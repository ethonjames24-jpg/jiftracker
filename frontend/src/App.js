...
const NonBlockingError = ({ message }) => (
  <div data-testid="nonblocking-error-banner" className="border-b-2 border-black bg-red-100 px-4 py-3 text-center text-sm font-bold text-red-900">{message}</div>
);
