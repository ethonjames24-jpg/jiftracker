...
export const fetchTrackerData = async (requestedMonth = "") => {
  ...
  return {
    ...
    current_month: {
      ...
      monthly_editorial_headline: preferExtras(extras, first, ["monthly_editorial_headline", "editorial_headline", "what_changed_headline", "public_summary_headline", "approved_tracker_summary_headline"]),
      ...
      receipts_check_status: preferExtras(extras, first, ["receipts_check_status", "receipts_checked_status", "receipts_checked_approved"]),
      ...
      source_document_1_owner: preferExtras(extras, first, ["source_document_1_owner", "source_document_1_publisher", "monthly_outturn_source_owner"]),
      source_document_1_publication_date: preferExtras(extras, first, ["source_document_1_publication_date", "monthly_outturn_publication_date"]),
      source_document_1_period: preferExtras(extras, first, ["source_document_1_period", "monthly_outturn_period"]),
      ...
      source_document_2_owner: preferExtras(extras, first, ["source_document_2_owner", "source_document_2_publisher", "budget_baseline_source_owner"]),
      source_document_2_publication_date: preferExtras(extras, first, ["source_document_2_publication_date", "budget_baseline_publication_date"]),
      source_document_2_period: preferExtras(extras, first, ["source_document_2_period", "budget_baseline_period"]),
      fiscal_year: preferExtras(extras, first, ["fiscal_year", "Fiscal Year"]),
